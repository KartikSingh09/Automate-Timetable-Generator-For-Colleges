<?php
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        $query = "SELECT * FROM student_info WHERE student_id='$adminid' AND student_password='$adminpass'";
        $result = mysqli_query($conn, $query);

        if (mysqli_num_rows($result) == 1) {
            $_SESSION['studentid'] = $adminid;
...
<head>
    ...
    <title>Student Login - Automatic Timetable Generator</title>
